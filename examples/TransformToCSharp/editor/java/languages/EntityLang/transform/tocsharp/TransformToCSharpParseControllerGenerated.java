...
public class TransformToCSharpParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("TransformToCSharp");
  ...
  { 
    TransformToCSharpParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = TransformToCSharpParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = TransformToCSharpParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(TransformToCSharpParseControllerGenerated.class);
    }
  ...
  { 
    return TransformToCSharpParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
