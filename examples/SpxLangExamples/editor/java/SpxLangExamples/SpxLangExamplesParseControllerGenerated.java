...
public class SpxLangExamplesParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("SpxLangExamples");
  ...
  { 
    SpxLangExamplesParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = SpxLangExamplesParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = SpxLangExamplesParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(SpxLangExamplesParseControllerGenerated.class);
    }
  ...
  { 
    return SpxLangExamplesParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
