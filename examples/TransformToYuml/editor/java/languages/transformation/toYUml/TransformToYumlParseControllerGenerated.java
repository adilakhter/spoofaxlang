...
public class TransformToYumlParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("TransformToYuml");
  ...
  { 
    TransformToYumlParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = TransformToYumlParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = TransformToYumlParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(TransformToYumlParseControllerGenerated.class);
    }
  ...
  { 
    return TransformToYumlParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
