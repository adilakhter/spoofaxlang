...
public class MiniLinqQueryParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("MiniLinqQuery");
  ...
  { 
    MiniLinqQueryParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = MiniLinqQueryParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = MiniLinqQueryParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(MiniLinqQueryParseControllerGenerated.class);
    }
  ...
  { 
    return MiniLinqQueryParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
