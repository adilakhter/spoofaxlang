...
public class YumlParseControllerGenerated extends DynamicParseController 
{ 
  ...
  { 
    YumlParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = YumlParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = YumlParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(YumlParseControllerGenerated.class);
    }
