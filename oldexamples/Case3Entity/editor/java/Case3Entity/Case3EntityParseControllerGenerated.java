...
public class Case3EntityParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("Case3Entity");
  ...
  { 
    Case3EntityParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = Case3EntityParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = Case3EntityParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(Case3EntityParseControllerGenerated.class);
    }
  ...
  { 
    return Case3EntityParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
