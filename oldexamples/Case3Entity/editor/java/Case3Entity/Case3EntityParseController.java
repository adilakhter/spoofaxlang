...
public class Case3EntityParseController extends DynamicParseController 
{ 
  ...
  { 
    try
    { 
      InputStream descriptorStream = Case3EntityParseController.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = Case3EntityParseController.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(Case3EntityParseController.class);
    }
