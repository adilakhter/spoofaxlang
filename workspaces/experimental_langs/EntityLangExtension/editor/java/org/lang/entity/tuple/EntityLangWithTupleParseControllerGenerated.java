...
public class EntityLangWithTupleParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("EntityLangWithTuple");
  ...
  { 
    EntityLangWithTupleParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = EntityLangWithTupleParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = EntityLangWithTupleParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(EntityLangWithTupleParseControllerGenerated.class);
    }
  ...
  { 
    return EntityLangWithTupleParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
