...
public class EntityLangExtensionParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("EntityLangExtension");
  ...
  { 
    EntityLangExtensionParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = EntityLangExtensionParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = EntityLangExtensionParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(EntityLangExtensionParseControllerGenerated.class);
    }
  ...
  { 
    return EntityLangExtensionParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
