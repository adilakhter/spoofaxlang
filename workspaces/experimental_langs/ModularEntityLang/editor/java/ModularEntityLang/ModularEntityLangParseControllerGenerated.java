...
public class ModularEntityLangParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("ModularEntityLang");
  ...
  { 
    ModularEntityLangParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = ModularEntityLangParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = ModularEntityLangParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(ModularEntityLangParseControllerGenerated.class);
    }
  ...
  { 
    return ModularEntityLangParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
