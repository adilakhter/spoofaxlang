...
public class MiniLINQParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("MiniLINQ");
  ...
  { 
    MiniLINQParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = MiniLINQParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = MiniLINQParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(MiniLINQParseControllerGenerated.class);
    }
  ...
  { 
    return MiniLINQParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
