...
public class TinySQLParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("TinySQL");
  ...
  { 
    TinySQLParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = TinySQLParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = TinySQLParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(TinySQLParseControllerGenerated.class);
    }
  ...
  { 
    return TinySQLParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
