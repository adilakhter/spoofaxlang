...
public class EntityTupleLangParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("EntityTupleLang");
  ...
  { 
    EntityTupleLangParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = EntityTupleLangParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = EntityTupleLangParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(EntityTupleLangParseControllerGenerated.class);
    }
  ...
  { 
    return EntityTupleLangParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
