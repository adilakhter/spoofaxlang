...
public class EntityLangEmbeddedParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("EntityLangEmbedded");
  ...
  { 
    EntityLangEmbeddedParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = EntityLangEmbeddedParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = EntityLangEmbeddedParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(EntityLangEmbeddedParseControllerGenerated.class);
    }
  ...
  { 
    return EntityLangEmbeddedParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
