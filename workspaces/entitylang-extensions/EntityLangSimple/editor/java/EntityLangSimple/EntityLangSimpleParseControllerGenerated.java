...
public class EntityLangSimpleParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("EntityLangSimple");
  ...
  { 
    EntityLangSimpleParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = EntityLangSimpleParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = EntityLangSimpleParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(EntityLangSimpleParseControllerGenerated.class);
    }
  ...
  { 
    return EntityLangSimpleParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
