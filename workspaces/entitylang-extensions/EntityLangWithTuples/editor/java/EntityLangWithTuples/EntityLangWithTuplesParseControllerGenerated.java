...
public class EntityLangWithTuplesParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("EntityLangWithTuples");
  ...
  { 
    EntityLangWithTuplesParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = EntityLangWithTuplesParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = EntityLangWithTuplesParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(EntityLangWithTuplesParseControllerGenerated.class);
    }
  ...
  { 
    return EntityLangWithTuplesParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
