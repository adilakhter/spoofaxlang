...
public class ExtendedEntityLangParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("ExtendedEntityLang");
  ...
  { 
    ExtendedEntityLangParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = ExtendedEntityLangParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = ExtendedEntityLangParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(ExtendedEntityLangParseControllerGenerated.class);
    }
  ...
  { 
    return ExtendedEntityLangParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
