...
public class SimpleEntityLangParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("SimpleEntityLang");
  ...
  { 
    SimpleEntityLangParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = SimpleEntityLangParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = SimpleEntityLangParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(SimpleEntityLangParseControllerGenerated.class);
    }
  ...
  { 
    return SimpleEntityLangParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
