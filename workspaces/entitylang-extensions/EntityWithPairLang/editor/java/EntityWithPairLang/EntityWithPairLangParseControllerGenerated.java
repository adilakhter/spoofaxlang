...
public class EntityWithPairLangParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("EntityWithPairLang");
  ...
  { 
    EntityWithPairLangParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = EntityWithPairLangParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = EntityWithPairLangParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(EntityWithPairLangParseControllerGenerated.class);
    }
  ...
  { 
    return EntityWithPairLangParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
