...
if(val9 !== null) {
  subs__.addSub(mobl.domBind(node10, 'tap', val9));
}

root19.append(node10);
...
if(val11 !== null) {
  subs__.addSub(mobl.domBind(node11, 'swipe', val11));
}

var nodes12 = $("<span>");
node11.append(nodes12);
...
var val12 = onclick.get();
if(val12 !== null) {
  subs__.addSub(mobl.domBind(node12, 'tap', val12));
}

var val13 = onswipe.get();
if(val13 !== null) {
  subs__.addSub(mobl.domBind(node12, 'swipe', val13));
}

var nodes13 = $("<span>");
node12.append(nodes13);
subs__.addSub(mobl.ref(elements).addEventListener('change', function() {
  renderControl3();
}));
...
var node14 = $("<div>");
node14.attr('class', "screenContext");

var ref19 = id;
if(ref19.get() !== null) {
  node14.attr('id', ref19.get());
...
node14.attr('style', "position: relative;");


var node15 = $("<div>");
node15.attr('class', "initialElements");

var nodes15 = $("<span>");
node15.append(nodes15);
subs__.addSub(mobl.ref(elements).addEventListener('change', function() {
  renderControl5();
}));
