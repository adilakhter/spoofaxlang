...
public class CommonLangParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("CommonLang");
  ...
  { 
    CommonLangParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = CommonLangParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = CommonLangParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(CommonLangParseControllerGenerated.class);
    }
  ...
  { 
    return CommonLangParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
