...
{ 
  ...
  @Override public IStrategoTerm invoke(Context context, IStrategoTerm term, IStrategoTerm c_92077)
  { 
    context.push("continue_to_label_CurrentFile_0_1");
    Fail76115:
    { 
      IStrategoTerm e_92077 = null;
      e_92077 = term;
      term = dr_continue_0_2.instance.invoke(context, e_92077, trans.const15448, c_92077);
      if(term == null)
        break Fail76115;
