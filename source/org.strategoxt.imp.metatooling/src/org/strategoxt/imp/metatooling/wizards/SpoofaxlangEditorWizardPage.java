...
public class SpoofaxlangEditorWizardPage extends WizardPage {
	 ...
	 */
	public SpoofaxlangEditorWizardPage(String title, String description) {
	...
	private boolean isCreatingANewProject(){return true;} 	
