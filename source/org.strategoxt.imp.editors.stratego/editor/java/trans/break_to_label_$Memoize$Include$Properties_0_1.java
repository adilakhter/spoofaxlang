...
{ 
  ...
  @Override public IStrategoTerm invoke(Context context, IStrategoTerm term, IStrategoTerm z_4327)
  { 
    ...
    { 
      ...
      b_4328 = term;
      term = dr_break_0_2.instance.invoke(context, b_4328, trans.const4374, z_4327);
      if(term == null)
        break Fail22215;
