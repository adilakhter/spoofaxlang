...
{ 
  ...
  @Override public IStrategoTerm invoke(Context context, IStrategoTerm term, Strategy y_4283)
  { 
    ...
    { 
      ...
      a_4284 = term;
      term = dr_get_first_scope_label_1_1.instance.invoke(context, a_4284, y_4283, trans.const4327);
      if(term == null)
        break Fail21951;
