...
{ 
  ...
  @Override public IStrategoTerm invoke(Context context, IStrategoTerm term, Strategy b_4332)
  { 
    ...
    { 
      ...
      d_4332 = term;
      term = dr_get_first_scope_label_1_1.instance.invoke(context, d_4332, b_4332, trans.const4394);
      if(term == null)
        break Fail22236;
