...
{ 
  ...
  @Override public IStrategoTerm invoke(Context context, IStrategoTerm term, IStrategoTerm n_4284)
  { 
    ...
    { 
      ...
      p_4284 = term;
      term = dr_break_0_2.instance.invoke(context, p_4284, trans.const4327, n_4284);
      if(term == null)
        break Fail21957;
